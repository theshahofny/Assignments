...
public class PigLatin {
	...
	private String breakDown(String word){
		...
		else if (ifFirstTwoConsonants(word))
			result = word.toLowerCase().substring(2) + word.toLowerCase().substring(0,2) + "ay ";

		else
			result = word.toLowerCase().substring(1) + word.toLowerCase().charAt(0) + "ay ";
		return result;
	}
